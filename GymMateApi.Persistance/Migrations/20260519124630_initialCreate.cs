...
namespace GymMateApi.Persistence.Migrations
{
    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CourseEntityTrainingEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseEntityTrainingEntity", x => new { x.CoursesId, x.TrainingsId });
                    table.ForeignKey(
                        name: "FK_CourseEntityTrainingEntity_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEntityTrainingEntity_Trainings_TrainingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseEntityTrainingEntity_TrainingsId",
                table: "CourseEntityTrainingEntity",
                column: "TrainingsId");
