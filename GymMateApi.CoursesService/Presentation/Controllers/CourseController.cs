...
using GymMateApi.CoursesService.Application.Courses.Commands.AddTrainingToCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.CreateCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.DeleteCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.RateCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.RemoveTrainingFromCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.SubscribeToCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.UnsubscribeFromCourse;
using GymMateApi.CoursesService.Application.Courses.Commands.UpdateCourse;
using GymMateApi.CoursesService.Application.Courses.Queries.GetAllCourses;
using GymMateApi.CoursesService.Application.Courses.Queries.GetCourseById;
using GymMateApi.CoursesService.Application.Courses.Queries.GetCoursesByRatingFilter;
using GymMateApi.CoursesService.Application.Courses.Queries.GetCoursesSortedByRating;
using GymMateApi.CoursesService.Presentation.Contracts.Course;
...
namespace GymMateApi.CoursesService.Presentation.Controllers;
...
public class CourseController(IMediator mediator) : ControllerBase
{
    ...
    public async Task<ActionResult> CreateCourse([FromBody] CourseUpsertRequest request,
    ...
    [HttpGet("sorted")]
    [Authorize]
    public async Task<ActionResult> GetCoursesSortedByRating([FromQuery] bool isDescending,
        CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    [Authorize(Roles = Roles.Admin)]
    public async Task<ActionResult> UpdateCourse([FromRoute] Guid id, [FromBody] CourseUpsertRequest request,
        CancellationToken cancellationToken)
    {
    ...
    {
        await mediator.Send(new SubscribeToCourseCommand(courseId, CurrentUserId), cancellationToken);
        return NoContent();
    }
    ...
    {
        await mediator.Send(new UnsubscribeFromCourseCommand(courseId, CurrentUserId), cancellationToken);
        return NoContent();
    }
}
